...
const BlogItem = ({_id,Title,Body,CreatedAt,index}) => {
...
<div className="card text-center">
  ...
  <div className="card-body">
    ...
    <Link to={`/blogs/${_id}/edit`} className="btn btn-primary">Edit Blog</Link>
    <Link to={`/blogs/${_id}/delete`} className="btn btn-primary">Delete Blog</Link>
